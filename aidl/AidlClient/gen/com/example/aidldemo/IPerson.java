 ...
 * Original file: D:\\workspace\\AidlClient\\src\\com\\example\\aidldemo\\IPerson.aidl
 */
package com.example.aidldemo;
public interface IPerson extends android.os.IInterface
{
/** Local-side IPC implementation stub class. */
public static abstract class Stub extends android.os.Binder implements com.example.aidldemo.IPerson
{
private static final java.lang.String DESCRIPTOR = "com.example.aidldemo.IPerson";
...
/**
 * Cast an IBinder object into an com.example.aidldemo.IPerson interface,
 * generating a proxy if needed.
 */
public static com.example.aidldemo.IPerson asInterface(android.os.IBinder obj)
{
if ((obj==null)) {
return null;
}
android.os.IInterface iin = obj.queryLocalInterface(DESCRIPTOR);
if (((iin!=null)&&(iin instanceof com.example.aidldemo.IPerson))) {
return ((com.example.aidldemo.IPerson)iin);
}
return new com.example.aidldemo.IPerson.Stub.Proxy(obj);
}
...
private static class Proxy implements com.example.aidldemo.IPerson
{
